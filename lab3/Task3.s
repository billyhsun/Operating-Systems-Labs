...
! The following class and its methods are from this package
	...
	.export	_Method_P_Main_GamingParlor_6
...
_mainEntry:
	...
	set	0x89355dbb,r3		! .  hashVal = -1992991301
...
_CheckVersion_P_Main_:
	...
	set	0x89355dbb,r4		! myHashVal = -1992991301
	cmp	r3,r4
	be	_Label_18
	set	_CVMess1,r1
	call	_putString
...
! ASSIGNMENT STATEMENT...
	...
	mov	"\0\0AS",r10
!   NEW CLASS Constructor...
!   ZeroMemory: _Global_condition = zeros  (sizeInBytes=16)
	set	_Global_condition,r4
	store	r0,[r4]
	store	r0,[r4+4]
	store	r0,[r4+8]
	store	r0,[r4+12]
!   _Global_condition = _P_Synch_Condition
	set	_P_Synch_Condition,r1
	set	_Global_condition,r2
	store	r1,[r2]
! SEND STATEMENT...
	mov	31,r13		! source line 31
	mov	"\0\0SE",r10
!   _temp_25 = &_Global_condition
	set	_Global_condition,r1
	store	r1,[r14+-204]
!   Send message Init
	load	[r14+-204],r1
	load	[r1],r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_26 = _StringConst_1
	set	_StringConst_1,r1
	store	r1,[r14+-200]
!   _temp_27 = &_Global_gamers
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_29 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-188]
!   _temp_30 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-184]
!   Move address of _temp_30 [0 ] into _temp_31
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_32 = _StringConst_2
	set	_StringConst_2,r1
	store	r1,[r14+-176]
!   _temp_33 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-172]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_35 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-164]
!   _temp_36 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-160]
!   Move address of _temp_36 [1 ] into _temp_37
!     make sure index expr is >= 0
	mov	1,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_41 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-140]
!   _temp_42 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-136]
!   Move address of _temp_42 [2 ] into _temp_43
!     make sure index expr is >= 0
	mov	2,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_47 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-116]
!   _temp_48 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-112]
!   Move address of _temp_48 [3 ] into _temp_49
!     make sure index expr is >= 0
	mov	3,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_50 = _StringConst_5
	set	_StringConst_5,r1
	store	r1,[r14+-104]
!   _temp_51 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-100]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_53 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-92]
!   _temp_54 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-88]
!   Move address of _temp_54 [4 ] into _temp_55
!     make sure index expr is >= 0
	mov	4,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_59 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-68]
!   _temp_60 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-64]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_62 = _StringConst_7
	set	_StringConst_7,r1
	store	r1,[r14+-56]
!   _temp_63 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-52]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_65 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-44]
!   _temp_66 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-40]
!   Move address of _temp_66 [6 ] into _temp_67
!     make sure index expr is >= 0
	mov	6,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_71 = _function_15_call_playgames
	set	_function_15_call_playgames,r1
	store	r1,[r14+-20]
!   _temp_72 = &_Global_gamers
	set	_Global_gamers,r1
	store	r1,[r14+-16]
!   Move address of _temp_72 [7 ] into _temp_73
!     make sure index expr is >= 0
	mov	7,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
_Label_127:
	...
	.align
! 
! ===============  FUNCTION call_playgames  ===============
! 
_function_15_call_playgames:
	push	r14
	mov	r15,r14
	push	r13
	set	_RoutineDescriptor__function_15_call_playgames,r1
	push	r1
	mov	3,r1
_Label_272:
	push	r0
...
! Routine Descriptor
! 
_RoutineDescriptor__function_15_call_playgames:
	.word	_sourceFileName
	.word	_Label_129
...
_P_Main_GamingParlor:
	...
	jmp	_Method_P_Main_GamingParlor_2	! 8:	playGames
	jmp	_Method_P_Main_GamingParlor_3	! 12:	Request
	jmp	_Method_P_Main_GamingParlor_4	! 16:	Return
	jmp	_Method_P_Main_GamingParlor_5	! 20:	PrintExample
	jmp	_Method_P_Main_GamingParlor_6	! 24:	Print
	.word	0
! 
! Class descriptor:
! 
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_136:
!   if numPlayed >= 5 then goto _Label_138		(int)
	load	[r14+-64],r1
	mov	5,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_140 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-60]
!   Move address of _temp_140 [gameNum ] into _temp_141
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-56]
!   Data Move: _temp_139 = *_temp_141  (sizeInBytes=1)
	load	[r14+-56],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
!   _temp_143 = &_P_Main_dice_per_group
	set	_P_Main_dice_per_group,r1
	store	r1,[r14+-48]
!   Move address of _temp_143 [gameNum ] into _temp_144
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-44]
!   Data Move: _temp_142 = *_temp_144  (sizeInBytes=4)
	load	[r14+-44],r1
	load	[r1],r1
	store	r1,[r14+-52]
	load	[r14+8],r1
...
!   Prepare Argument: offset=12  value=_temp_139  sizeInBytes=1
	loadb	[r14+-10],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_142  sizeInBytes=4
	load	[r14+-52],r1
	store	r1,[r15+8]
...
!   _temp_147 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-36]
!   Move address of _temp_147 [gameNum ] into _temp_148
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   _temp_150 = &_P_Main_dice_per_group
	set	_P_Main_dice_per_group,r1
	store	r1,[r14+-24]
!   Move address of _temp_150 [gameNum ] into _temp_151
!     make sure index expr is >= 0
	load	[r14+12],r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!   Prepare Argument: offset=12  value=name  sizeInBytes=1
	loadb	[r14+12],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_172  sizeInBytes=4
	load	[r14+-36],r1
	store	r1,[r15+8]
...
! WHILE STATEMENT...
	...
	mov	"\0\0WH",r10
_Label_174:
!   if dice_available >= nr_of_dice then goto _Label_176		(int)
	load	[r14+8],r1
	load	[r1+4],r1
	load	[r14+16],r2
	cmp	r1,r2
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_177 = &_Global_mutex
	set	_Global_mutex,r1
	store	r1,[r14+-28]
!   _temp_178 = &_Global_condition
	set	_Global_condition,r1
	store	r1,[r14+-24]
...
!   Prepare Argument: offset=12  value=name  sizeInBytes=1
	loadb	[r14+12],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_179  sizeInBytes=4
	load	[r14+-20],r1
	store	r1,[r15+8]
!   Prepare Argument: offset=20  value=nr_of_dice  sizeInBytes=4
	load	[r14+16],r1
...
!   Prepare Argument: offset=12  value=name  sizeInBytes=1
	loadb	[r14+12],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=_temp_195  sizeInBytes=4
	load	[r14+-28],r1
	store	r1,[r15+8]
!   Prepare Argument: offset=20  value=nr_of_dice  sizeInBytes=4
	load	[r14+16],r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_197 = &_Global_mutex
	set	_Global_mutex,r1
	store	r1,[r14+-20]
!   _temp_198 = &_Global_condition
	set	_Global_condition,r1
	store	r1,[r14+-16]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_211 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-88]
!   Move address of _temp_211 [0 ] into _temp_212
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-84]
!   Data Move: _temp_210 = *_temp_212  (sizeInBytes=1)
	load	[r14+-84],r1
	loadb	[r1],r1
	storeb	r1,[r14+-14]
	load	[r14+8],r1
...
!   if intIsZero (_temp_213) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_210  sizeInBytes=1
	loadb	[r14+-14],r1
	storeb	r1,[r15+4]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_215 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-76]
!   Move address of _temp_215 [1 ] into _temp_216
!     make sure index expr is >= 0
	mov	1,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-72]
!   Data Move: _temp_214 = *_temp_216  (sizeInBytes=1)
	load	[r14+-72],r1
	loadb	[r1],r1
	storeb	r1,[r14+-13]
	load	[r14+8],r1
...
!   if intIsZero (_temp_217) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_214  sizeInBytes=1
	loadb	[r14+-13],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=4  sizeInBytes=4
	mov	4,r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_219 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-64]
!   Move address of _temp_219 [1 ] into _temp_220
!     make sure index expr is >= 0
	mov	1,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-60]
!   Data Move: _temp_218 = *_temp_220  (sizeInBytes=1)
	load	[r14+-60],r1
	loadb	[r1],r1
	storeb	r1,[r14+-12]
	load	[r14+8],r1
	store	r1,[r14+-56]
!   if intIsZero (_temp_221) then goto _runtimeErrorNullPointer
	load	[r14+-56],r1
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_218  sizeInBytes=1
	loadb	[r14+-12],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=4  sizeInBytes=4
	mov	4,r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_223 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-52]
!   Move address of _temp_223 [0 ] into _temp_224
!     make sure index expr is >= 0
	mov	0,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-48]
!   Data Move: _temp_222 = *_temp_224  (sizeInBytes=1)
	load	[r14+-48],r1
	loadb	[r1],r1
	storeb	r1,[r14+-11]
	load	[r14+8],r1
...
!   if intIsZero (_temp_225) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_222  sizeInBytes=1
	loadb	[r14+-11],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=4  sizeInBytes=4
	mov	4,r1
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_227 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-40]
!   Move address of _temp_227 [2 ] into _temp_228
!     make sure index expr is >= 0
	mov	2,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-36]
!   Data Move: _temp_226 = *_temp_228  (sizeInBytes=1)
	load	[r14+-36],r1
	loadb	[r1],r1
	storeb	r1,[r14+-10]
	load	[r14+8],r1
...
!   if intIsZero (_temp_229) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_226  sizeInBytes=1
	loadb	[r14+-10],r1
	storeb	r1,[r15+4]
...
! SEND STATEMENT...
	...
	mov	"\0\0SE",r10
!   _temp_231 = &_P_Main_group_names
	set	_P_Main_group_names,r1
	store	r1,[r14+-28]
!   Move address of _temp_231 [2 ] into _temp_232
!     make sure index expr is >= 0
	mov	2,r2
	cmp	r2,0
	bl	_runtimeErrorBadArrayIndex
...
!     compute address of array element
	...
	add	r2,r1,r2
	store	r2,[r14+-24]
!   Data Move: _temp_230 = *_temp_232  (sizeInBytes=1)
	load	[r14+-24],r1
	loadb	[r1],r1
	storeb	r1,[r14+-9]
	load	[r14+8],r1
...
!   if intIsZero (_temp_233) then goto _runtimeErrorNullPointer
	...
	cmp	r1,r0
	be	_runtimeErrorNullPointer
!   Prepare Argument: offset=12  value=_temp_230  sizeInBytes=1
	loadb	[r14+-9],r1
	storeb	r1,[r15+4]
!   Prepare Argument: offset=16  value=5  sizeInBytes=4
	mov	5,r1
...
! ===============  METHOD Print  ===============
! 
_Method_P_Main_GamingParlor_6:
	push	r14
	mov	r15,r14
	push	r13
	set	_RoutineDescriptor__Method_P_Main_GamingParlor_6,r1
	push	r1
	mov	4,r1
_Label_277:
	push	r0
...
! Routine Descriptor
! 
_RoutineDescriptor__Method_P_Main_GamingParlor_6:
	.word	_sourceFileName
	.word	_Label_263
